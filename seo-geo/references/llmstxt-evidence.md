...
ranking or citation lever in any GEO report.
...
- A GEO audit **reports presence** of `/llms.txt` and `/llms-full.txt`.
...
- If the user asks to generate one, produce a minimal valid example and a
  banner stating "no major LLM provider has confirmed consumption as of
  May 2026; ship for optionality, not for citation".

## When this guidance changes

Update this file (and the corresponding SKILL.md section) when:
